...
import AnimatedOLMap from '../../components/AnimatedOLMap';
...
const LevelMap = (props: LevelMapProps) => {
    ...
    function animatedFillData(itMapData: any) {
        let len = itMapData.size;

        Array.prototype.forEach.call(itMapData, olAnimatedColorHandler)
    }
    ...
    function olAnimatedColorHandler(name: string) {
    ...
    function olLoadHandler(name: string) {
        return props.loadHandler(name.toUpperCase());
    }
            ...
            <Layout>
                <Layout.Content>
                    ...
                    <Radio.Group onChange={(e) => setHeatMapType(e.target.value)}
                        ...
                        <Radio.Button value={'animate'} onChange={(e) => (e)}>Animate</Radio.Button>
                    ...
                    <AnimatedOLMap toolTipHandler={(name) => olToolTipHandler(name)}
                        ...
                        //animatedColorHandler={(name) => olAnimatedColorHandler(name)}
    ...
    function replace() {
        const myElement: HTMLElement | null = document.getElementById('OlMapDiv');
        const theElement: HTMLElement | null = document.getElementById('OlMapDiv');
        if (!!myElement && theElement) {
